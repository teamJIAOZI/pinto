...
{   
     ...
     public function menindex(Request $request)
    {
        ...
        $items = \DB::table('items')->select('id', 'items','story','price', 'item_brand','img_path')->where('gender', '1')->orderByRaw('RANDOM('.$number.')')->paginate(12);
     ...
     public function womenindex(Request $request)
    {
        ...
        $items = \DB::table('items')->select('id','items','story','price', 'item_brand','img_path')->where('gender', '2')->orderByRaw('RANDOM('.$number.')')->paginate(12);
    ...
    public function mensearch(Request $request)
    {
        ...
        $items = \DB::table('items')->select('id','items','story','price', 'item_brand','img_path')->where('gender', '1')->where('kind', $value)->orderByRaw('RANDOM('.$number.')')->paginate(12);
    ...
    public function womensearch(Request $request)
    {
        ...
        $items = \DB::table('items')->select('id','items','story','price', 'item_brand','img_path')->where('gender', '2')->where('kind', $value)->orderByRaw('RANDOM('.$number.')')->paginate(12);
        $items->appends(['answers' => $value]);
